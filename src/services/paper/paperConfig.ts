...
export const VENUE_TEMPLATES: VenueTemplate[] = [
	...
	// ── General ──
	{
		...
		hasBroaderImpact: false,
		hasLimitations: false,
		templateDirName: "IEEE_Conference_Template",
		primaryTexFile: "conference_101719.tex",
	...
	},
	{
		...
		hasBroaderImpact: false,
		hasLimitations: false,
		templateDirName: "IEEE_Transactions_Templates",
		primaryTexFile: "bare_jrnl_new_sample4.tex",
		skillNames: ["academic-plotting"],
	},
	{
		id: "ieee-tcom",
...
export function getVenueTemplatesByType(type: "ml" | "systems" | "general" | "ieee"): VenueTemplate[] {
